...
export default function Home() {
  ...
  async function handleCatalogUpload(e) {
    ...
    try {
      ...
      setUploadMessage(`${data.count.toLocaleString()}건의 소장도서가 등록되었습니다.`);
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-5 py-8">
        {view === "apply" && (
          <div className="max-w-xl mx-auto">
              ...
              {!catalogSearching && catalogSearched && catalogResults.length > 0 && (
                <div className="mt-3 space-y-1.5">
                  <p className="text-[12px] text-[#0F6E56] font-medium flex items-center gap-1">
                    <Check size={12} /> 우리 도서관에 있어요! ({catalogResults.length}건)
                  </p>
            ...
            <div className="mb-6">
              <h2
                className="text-[24px] font-bold text-[#26215C] mb-1.5"
                style={{ fontFamily: "'Single Day', sans-serif" }}
              >
                ✨ 읽고 싶은 책을 신청해 주세요!
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[13px] font-bold text-[#26215C] mb-1.5">
                  🟣 신청자 구분
                </label>
        ...
        {view === "admin" && authed && (
          <div>
            <div className="mb-6 rounded-xl border border-[#E4DCC8] bg-white p-4">
              <h3 className="text-[14px] font-bold text-[#26215C] mb-1 flex items-center gap-1.5">
