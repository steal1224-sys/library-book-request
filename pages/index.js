          ...
          <div className="max-w-xl mx-auto md:max-w-none">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full flex items-center justify-center gap-2 rounded-md bg-[#B45309] text-white py-2.5 text-[14px] font-medium hover:bg-[#92400E] transition-colors disabled:opacity-60"
              >
                <BookPlus size={16} />
          ...
          <div className="max-w-sm mx-auto mt-10 text-center">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={loggingIn}
                className="w-full rounded-md bg-[#B45309] text-white py-2.5 text-[14px] font-medium hover:bg-[#92400E] transition-colors disabled:opacity-60"
              >
                {loggingIn ? "확인 중..." : "확인"}
              </button>
            </form>
