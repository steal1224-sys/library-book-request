      ...
      <main className="flex-1 max-w-3xl md:max-w-6xl mx-auto w-full px-5 py-8">
        {view === "apply" && (
          <div className="max-w-xl mx-auto md:max-w-none">
            {/* 웹: 3단 카드 레이아웃 / 모바일: 기존 세로 스크롤 */}
            <div className="md:grid md:grid-cols-3 md:gap-6 md:items-start">
              {/* 카드 1: 소장 검색 */}
              <div className="md:rounded-xl md:border md:border-[#DDD8F0] md:shadow-sm md:overflow-hidden">
                <div className="hidden md:flex md:items-center md:gap-2 md:bg-[#04657A] md:px-4 md:py-3">
            ...
            <div className="mb-7 md:mb-0 rounded-xl border border-[#DDD8F0] bg-white p-4 md:border-0 md:rounded-none md:shadow-none md:p-0">
              ...
              {/* 카드 2: 신청 안내 (웹에서만 표시) */}
              <div className="hidden md:block md:rounded-xl md:border md:border-[#DDD8F0] md:shadow-sm md:overflow-hidden">
                <div className="flex items-center gap-2 bg-[#02343F] px-4 py-3">
                  <span style={{ fontSize: "14px" }}>📋</span>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <p className="text-[12px] text-[#4B5563] leading-relaxed">** 도서명을 입력하면 알라딘 검색 결과가 나타나요. 원하는 책을 선택하면 저자·출판사·출판년도가 자동으로 채워집니다.</p>
                  <div className="border-t border-[#DDD8F0] pt-3 space-y-2">
                    <div className="flex items-start gap-2 text-[12px] text-[#4A6B70]"><span className="text-[#04657A] font-bold shrink-0">·</span>도서명과 저자는 꼭 입력해주세요</div>
                    <div className="flex items-start gap-2 text-[12px] text-[#4A6B70]"><span className="text-[#04657A] font-bold shrink-0">·</span>알라딘 자동 검색을 지원해요</div>
                    <div className="flex items-start gap-2 text-[12px] text-[#4A6B70]"><span className="text-[#04657A] font-bold shrink-0">·</span>신청 후 검토를 거쳐 구입 여부를 결정합니다</div>
                    <div className="flex items-start gap-2 text-[12px] text-[#4A6B70]"><span className="text-[#04657A] font-bold shrink-0">·</span>중복 신청은 삼가 주세요</div>
                  </div>
